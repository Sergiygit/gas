(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-video-gallery")) new swiper_core_Swiper(".swiper-video-gallery", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".swiper-video-gallery-button-prev",
                nextEl: ".swiper-video-gallery-button-next"
            },
            breakpoints: {
                640: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".swiper-photo-gallery")) new swiper_core_Swiper(".swiper-photo-gallery", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".swiper-photo-gallery-button-prev",
                nextEl: ".swiper-photo-gallery-button-next"
            },
            breakpoints: {
                640: {
                    slidesPerView: 1,
    ...
    for (let i = 0; i < menuLink.length; i++) if (menuLink[i].id == pageName.id) menuLink[i].classList = "menu__link _active";
    window["FLS"] = true;
    isWebp();
    menuInit();
    pageNavigation();
